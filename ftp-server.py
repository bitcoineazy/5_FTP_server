...
cat (потом ввести имя файла) - отправляет содержимое файла
mkdir (потом предложат ввести название новой директории) - создание новой директории
rmdir (потом ввести имя директории) - удалить директорию
rm (потом ввести имя файла) - удалить файл
rename (имя файла, новое название) - переименовать файл или директорию
cd (имя директории) - переместиться в директорию
cd .. - переместиться наверх (работает защита)
copy from server (название файла) - копировать файл из сервера (server_storage) в директорию клиента (clientstorage)
copy to server (название файла) - копировать файл на сервер из директории клиента
'''
